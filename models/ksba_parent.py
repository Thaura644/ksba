# kenya_school_bus_app/models/ksba_parent.py
...
class KsbaParent(models.Model):
    ...
    partner_id = fields.One2many('ksba.partners', 'parent_id', string="Partner")
    children_ids = fields.One2many('ksba.child', 'parent_id', string="Children")
